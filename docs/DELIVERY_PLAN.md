...
- Feature 20: Fix the iPhone app to landscape right, including Hosts and terminal screens. Do not rotate when the phone moves. Keep iPad orientation under user control. Pending implementation. Feature 19 has passed its deployment checkpoint.
